...
public class InstructorManager implements InstructorDao {
    ...
    // equalsIgnoreCase -> girilen String değeri küçük büyük bakmaksızın kontrol eder ona göre bir hata fırlatır
    @Override
    public void add(Instructor instructor) throws Exception {
        //bu değişkenlerin bir fakrı yok sade olması açısından bir değişkene eşitlendi
